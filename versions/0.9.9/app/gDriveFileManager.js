...
const gDriveFileManager = (() => {
    ...
    async function isSignedIn () {
        ...
        if (AuthObject == null) {
            ...
            AuthObject = gapi.auth2.getAuthInstance({client_id: configManager.getProp('CLIENT_ID')});
        }
        ...
        try {
            ...
            if (!signedin) {
	            ...
	            await gapi.client.init({
                    ...
                    clientId: configManager.getProp('CLIENT_ID'),
               ...
               )
	        {
		        ...
		        if (confirm(msg)) {
                    try {
                        ...
                        configManager.removeWarning(); // warning may have been set, safe to remove
    ...
    function reAuth(callback) {
        ...
        gapi.auth.authorize(
            {client_id: configManager.getProp('CLIENT_ID'), scope: Scopes, immediate: true}
        ).then((res) => {
